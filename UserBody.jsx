...
function UserBody() {
    const currentApplicant = {
        ...
        experience: [
            {
                ...
                from: "Jan 2019",
                to: "Dec 2021",
                rolesResponsibilities: "Developed and maintained code for deep learning software projects based on the needs of client."
            },
            {
                ...
                from: "Jan 2017",
                to: "Dec 2018",
                rolesResponsibilities: "Assisted in the development of web applications and performed bug fixes."
            }
        ],
        education: [
            {
        ...
        cover_letter: "I am enthusiastic about software development and technology..."
    };
    ...
    const handleRejection = async () => {
        ...
        try {
            ...
            console.log("Rejection status:", response.status);
        } catch (error) {
